...

{
  ...
  variable $mg1 := nosql:multi-get-string($db, $parentKey, { "start" : "a", "end": "b" }, "PARENT_AND_DESCENDANTS", "FORWARD");

  variable $mg2 := nosql:multi-get-string($db, $parentKey, { "start" : "m3", "end": "m4" }, "PARENT_AND_DESCENDANTS", "FORWARD");

  variable $mg3 := nosql:multi-get-string($db, $parentKey, { "start" : "a", "end" : "z" }, "PARENT_AND_DESCENDANTS", "FORWARD");
